...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: projects/doscmd/timer.c,v 1.8 2002/03/07 12:52:27 obrien Exp $");
...
{
    *(u_int32_t *)&BIOSDATA[0x6c] += 1;    /* ticks since midnight */
    while (*(u_int32_t *)&BIOSDATA[0x6c] >= 24*60*6*182) {
	*(u_int32_t *)&BIOSDATA[0x6c] -= 24*60*6*182;
